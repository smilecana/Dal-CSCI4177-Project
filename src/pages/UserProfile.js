...
import {Button, Container, Form, FormControl, Image, InputGroup,} from "react-bootstrap";
                ...
                <Form onSubmit={submitForm}>
                    ...
                    <Form.Group md="4">
                        <InputGroup>
                            ...
                            <FormControl id="inlineFormInputGroupUsername" placeholder="Github"
                                         onChange={(e) => handleInputChange('github', e)} value={user.github}/>
                        </InputGroup>
                    </Form.Group>
                    <Form.Group md="4">
                        <InputGroup>
                            ...
                            <FormControl placeholder="LinkedIn" onChange={(e) => handleInputChange('linkedin', e)}
                                         value={user.linkedin}/>
                        </InputGroup>
                    </Form.Group>
                    <Form.Group md="4">
                        <InputGroup>
                            ...
                            <FormControl id="inlineFormInputGroupUsername" placeholder="Website"
                                         onChange={(e) => handleInputChange('web', e)} value={user.web}/>
                        </InputGroup>
                    </Form.Group>
